...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2024 a las 21:42:00
...
CREATE TABLE `administradores` (
  ...
  `Correo_Electronico` varchar(16) NOT NULL,
...
INSERT INTO `administradores` (`Id`, `Usuario`, `Correo_Electronico`, `Password`, `estatus`, `Rol`) VALUES
(1, 'victor', 'victorcamacaro25', '13467', 'activo', 'Gerente'),
(7, 'ana', 'aleja@gmail.com', '677d79d84adddc0c6f54c421534b3f48', 'activo', ''),
(8, 'Alejandra', 'victorcamacaro25', 'fcea920f7412b5da7be0cf42b8c93759', 'activo', 'rrhh'),
(9, 'ana', 'aleja@gmail.com', '677d79d84adddc0c6f54c421534b3f48', 'activo', ''),
(10, 'ana', 'aleja@gmail.com', '677d79d84adddc0c6f54c421534b3f48', 'activo', ''),
(12, 'gerencia', 'gerencia2024@gma', '742bd91d2d21061e40359913fbff49d7', 'activo', 'gerencia');
...
CREATE TABLE `bienes` (
  ...
  `tipo_bien` varchar(250) NOT NULL,
  `fecha_adquisicion` date NOT NULL,
  `valor_bien` varchar(250) NOT NULL,
  `estado_bien` varchar(250) NOT NULL,
...
INSERT INTO `bienes` (`id_bien`, `nombre_bien`, `tipo_bien`, `fecha_adquisicion`, `valor_bien`, `estado_bien`, `Responsable`, `ubicacion`, `numero_serie`, `proveedor`) VALUES
(1, 'computadora hp elidesdk', 'Tecnologico', '2023-10-10', '120', 'Bueno', 6, 'Oficina de recursos humanos', '0001', 'nexconn'),
(2, 'Escritorio Secretarial De Oficina', 'mobiliario de oficina', '2016-07-07', '250', 'bueno', 5, 'oficina de admiinstracion', '000002', 'sofa'),
(3, 'Dell Oltiplex', 'tecologia', '2023-10-30', '120', 'Bueno', 10, 'programas y proyectos', '003', 'nexconn');
...
CREATE TABLE `cargos` (
  ...
  `Tipo` enum('Alto nivel','Empleado','Contratado','Obrero') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `cargos` (`Id_cargo`, `Cargo`, `Tipo`) VALUES
(1, 'Jefe de unidad de presupuesto', 'Alto nivel'),
(2, 'Jefe de unidad de contabilidad', 'Alto nivel'),
(3, 'Jefe de unidad de tesoreria', 'Alto nivel'),
(4, 'Jefe de unidad de patrimonial de bienes', 'Alto nivel'),
(5, 'Gerente de planificación y control de gestion ', 'Alto nivel'),
(6, 'Jefe de oficina de informática y estadística', 'Alto nivel'),
(7, 'Gerente de administración,finanzas y presupuesto', 'Alto nivel'),
(8, 'Jefe de la oficina de gestión comunicacional y protocolo', 'Alto nivel'),
(9, 'Jefe de Oficina de atención al ciudadano', 'Alto nivel'),
(10, 'Asistente Administrativo I', 'Empleado'),
(11, 'Vigilante', 'Obrero'),
(12, 'Aseadora', 'Obrero'),
(13, 'Analista de programas y proyectos I', 'Empleado'),
(14, 'Chofer', 'Empleado'),
(15, 'Obrero', 'Obrero'),
(16, 'Analista de Recursos Humanos', 'Empleado'),
(17, 'Consultor Juridico', 'Alto nivel'),
(18, 'Gerente de Programas y Proyectos', 'Alto nivel'),
(19, 'Gerente General', 'Alto nivel'),
(20, 'Gerente de Recursos Humanos', 'Alto nivel');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cdees_datos`
--

CREATE TABLE `cdees_datos` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `cdees_datos`
--

INSERT INTO `cdees_datos` (`id`, `Nombre`, `Direccion`, `Telefono`, `Rif`, `Presidente`) VALUES
(1, 'Corporación de Desarrollo Endogeno y Económico del estado Lara', 'Carrera 4 entre Calles 25 y 25 Centro, Nuevas Empresas Zona Industrial I Barquisimeto ', '0251-2371870/0251-2377668', 'G-20006480-3', 21);
...
--
-- Estructura de tabla para la tabla `datosescolares_hijostrabajadores`
--

CREATE TABLE `datosescolares_hijostrabajadores` (
  `Id` int(11) NOT NULL,
  ...
  `Tipo-I` varchar(30) NOT NULL,
  `Tipo-II` varchar(30) NOT NULL,
  `Escuela_Colegio` varchar(250) NOT NULL,
  `Estado` int(11) NOT NULL,
  `Municipio` int(11) NOT NULL,
  `Parroquia` int(11) NOT NULL,
  `Talla-Pantalon` int(11) NOT NULL,
  `Talla-camisa` int(11) NOT NULL,
  `Talla-Zapato` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `datosescolares_hijostrabajadores`
--

INSERT INTO `datosescolares_hijostrabajadores` (`Id`, `id_empleado`, `Nombre`, `Apellido`, `cedula`, `fecha_nacimiento`, `Edad`, `Grado`, `Tipo-I`, `Tipo-II`, `Escuela_Colegio`, `Estado`, `Municipio`, `Parroquia`, `Talla-Pantalon`, `Talla-camisa`, `Talla-Zapato`) VALUES
(1, 33, 'JOSWIL', 'MELENDEZ', '32314706', '2008-01-01', 15, '5TO. GRADO', 'PUBLICO', 'ESTATAL', 'ESCUELA ESTADAL SIMON RODRIGUEZ', 12, 146, 463, 14, 14, 35),
(2, 33, 'JESUS', 'MELENDEZ', '', '2016-11-15', 7, '2DO. GRADO', 'PUBLICO', 'ESTATAL', 'ESCUELA ESTADAL SIMON RODRIGUEZ', 12, 146, 463, 12, 12, 33);
...
INSERT INTO `departamentos` (`id_departamento`, `Departamento`, `Encargado`, `Imagen`) VALUES
(1, 'Presidencia', 'Lcda. Ivette Segovia', ''),
(2, 'Atencion_al_ciudadano', 'Yelimar Garcia', ''),
(3, 'Consultoría Jurídica', 'Abg. Jumarit Gonzalez', ''),
(4, 'Gerencia General', 'Lcda. Yohelis Gonzalez', 'Yohelys Gonzalez.jpg'),
(5, 'Gerencia de\r\nAdministración, Finanzas\r\ny presupuesto', 'Lcda. Magaly Meza', ''),
(6, 'Gerencia De Recursos\r\nHumanos', 'Lcdo. Wilniv Melendez', ''),
(7, 'Gerencia De\r\nPlanificación Y Control\r\nDe Gestión', 'Lcdo. Josue Briceño', ''),
(8, 'Oficina De Gestión\r\nComunicacional Y\r\nProtocolo', 'Lcda. Francistomar Cordero', ''),
(9, 'Oficina De\r\nInformatica Y\r\nEstadistica', 'Lcdo. Luis Mendoza', ''),
(10, 'Gerencia De\r\nProgramas Y\r\nProyectos', 'Lcdo. Yohelys Gonzalez', ''),
(11, 'Unidad De\r\nParticipacion\r\nCiudadana,Comunal E\r\nInstitucional', 'Yelimar Garcia', ''),
(12, 'Unidad De\r\nDesarrollo\r\nAgroecologico', 'Agr. Juan Soteldo', ''),
(13, 'Coordinacion\r\nFundoagricola\r\nLas Virtudes', 'Elio Palacios', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `detallepresuspuesto`
--

CREATE TABLE `detallepresuspuesto` (
  `id_detalle` int(11) NOT NULL,
  `id_presupuesto` int(11) NOT NULL,
  `id_articulo_servicio` int(11) NOT NULL,
...
INSERT INTO `documentos` (`id_documento`, `documento`, `Tipo_documento`, `departamento`, `descripcion`, `fecha`) VALUES
(1, 'SISTEMA DE MONITOREO DE PACIENTES PROYECTO IOT.docx', 'nomina', 6, 'h63a', '0000-00-00'),
(2, 'TODO sobre el personal de Cdees.xls', 'nomina', 6, 'h63a', '0000-00-00'),
(3, 'Ley de creacion CDEES (1).pdf', 'ley', 1, 'h63a', '0000-00-00');
...
CREATE TABLE `empleados` (
  ...
  `Id_cargo` int(11) NOT NULL,
  `Talla-camisa` varchar(11) NOT NULL,
  `Talla-pantalon` int(11) NOT NULL,
  `Talla-zapato` int(11) NOT NULL,
...
INSERT INTO `empleados` (`id_empleado`, `Primer_nombre`, `Segundo_Nombre`, `Primer_apellido`, `Segundo_apellido`, `cedula`, `Genero`, `Correo_electronico`, `direccion`, `id_estado`, `id_municipio`, `id_parroquia`, `id_ciudad`, `telefono`, `Id_cargo`, `Talla-camisa`, `Talla-pantalon`, `Talla-zapato`, `fecha-ingreso`, `fecha-salida`, `estatus`, `imagen`) VALUES
(2, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, 'S', 30, 35, '2023-10-03', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(4, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '2023-10-03', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(5, 'Jesus', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', ''),
(7, 'Fabiola', 'andreina', 'Hernandez', 'Mascareño', '27119375', 'F', 'victorcamacarogmail.com', 'URBANIZACIÓN DON PIO ALVARADO DERECHA CALLE CINCO. IZQUIERDA CALLE SIETE. FRENTE CALLE CUATRO A 100 METROS DE LOS CHINOS CASA', 12, 200, 150, 20, '123', 10, '', 0, 0, '2016-10-17', '2023-10-25', 'inactivo', ''),
(8, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(9, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(10, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '2023-10-03', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(11, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(12, 'Victor', 'Manuel  ', 'Camacaro  ', 'Alvarez  ', '27119364  ', 'M', 'victorcamacarogmail.com  ', 'carora  ', 12, 200, 150, 20, '123  ', 10, '  ', 0, 0, '0000-00-00', '0000-00-00', 'activo', 'victor_camacaro.png'),
(13, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(14, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 11, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', 'victor_camacaro.png'),
(15, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(16, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', 'victor_camacaro.png'),
(17, 'Edgar', 'E', 'Garcia', '', '10827223', 'M', 'nomelose@gmail.com', 'algun lugar de barquisimeto', 12, 200, 150, 20, '123', 1, '', 0, 0, '2014-10-01', '0000-00-00', 'activo', 'Edgar_Garcia.png'),
(18, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', ''),
(19, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', ''),
(20, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', ''),
(21, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', ''),
(22, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'inactivo', ''),
(23, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', ''),
(24, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', ''),
(25, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', ''),
(26, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', 'victor_camacaro.png'),
(27, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', 'victor_camacaro.png'),
(29, 'Ana', 'beatriz', 'alvarez', 'zambrano', '9846893', 'M', 'victorcamacarogmail.com', 'valencia', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', 'victor_camacaro.png'),
(30, 'Victor', 'Manuel', 'Camacaro', 'Alvarez', '27119364', 'M', 'victorcamacarogmail.com', 'carora', 12, 200, 150, 20, '123', 10, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', 'victor_camacaro.png'),
(33, 'Wilniv', 'Jesus', 'Melendez', 'Daza', '14512096', 'M', 'nomelose@gmail.com', 'SECTOR SIMON RODRIGUEZ FRENTE CALLE 47. DERECHA CARRERA 31. IZQUIERDA CARRERA 30 A 20 METROS DE LA A', 12, 146, 250, 212, '0412-000000', 16, '', 0, 0, '2013-10-08', '0000-00-00', 'activo', 'wilniv_melendez.png'),
(34, 'Sharon', 'Esther', 'Torres', 'Caruci', '18103018', 'F', 'nomelose@gmail.com', 'BARRIO LOS LUISES DERECHA CALLE 15. IZQUIERDA CALLE 14. FRENTE CARRERA 9 DETRAS DE LA ESCUELA EZEQUI', 12, 146, 250, 212, '04126103482', 8, '', 0, 0, '2020-10-08', '0000-00-00', 'activo', 'sharon_torres.png'),
(76, 'angela', 'vanessa', 'hernandez', 'lameda', '27119364', 'M', 'victor@gmail.com', 'la greda', 12, 151, 494, 215, '1234567', 3, '', 0, 0, '2023-10-08', '0000-00-00', 'activo', ''),
(77, 'angelo', 'nose', 'riera', 'no', '56464564', 'M', 'victor@gmail.com', 'la greda', 4, 36, 107, 54, '5564654', 5, '', 0, 0, '2023-10-17', '0000-00-00', 'activo', '1694114780500.jpg'),
(78, 'Mirlangel', 'jose', 'cortez', 'melendez', '28123465', 'F', 'mc@gmail.com', '', 4, 38, 117, 55, '1234567', 2, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', '1695957671681.jpg'),
(80, 'Yohelis   ', 'Carolina    ', 'Gonzalez   ', 'Arrieche   ', '17194961   ', 'F', 'cdeesyohelysgonzalez@gmail.com   ', 'urbanizacion ali primera, zona 10 torre  ', 12, 146, 467, 212, '  04149503241 ', 19, '   ', 0, 0, '2009-05-04', '0000-00-00', 'activo', 'Yohelys Gonzalez.JPG'),
(83, 'ivette', '', 'segovia', '', '1234567', '', '', '', 12, 342, 76, 212, '', 14, '', 0, 0, '0000-00-00', '0000-00-00', 'activo', ''),
(84, 'Jose', 'Andres', 'castro', 'nose', '98765432', 'M', 'jsesuscastro@gmail.com', 'barquisimeto', 12, 146, 250, 212, '1234567', 10, '7', 5, 8, '2019-08-14', '0000-00-00', 'activo', ''),
(94, 'Anaaaaa', 'aaaaa', 'aaaa', 'aalala', '123456790', 'M', 'victor@gmail.com', 'carora', 1, 1, 1, 1, '1234567', 1, '', 0, 0, '2024-05-11', '2024-08-15', 'activo', 'victor.jpg');
...
INSERT INTO `galeria` (`id_imagen`, `id_noticia`, `imagen`, `fecha_imagen`) VALUES
(1, 1, 'lara-exportable-1.webp', '2023-11-01'),
(2, 1, 'lara-exportable-2.jpeg', '2023-11-01'),
(3, 1, 'lara-exportable-3.jpeg', '2023-11-01'),
(4, 1, 'lara-exportable-4.jpeg', '0000-00-00'),
(5, 2, 'unidad-dialisis-1.jpeg', '2023-07-12'),
(6, 2, 'unidad-dialisis-2.jpeg', '2023-07-12'),
(9, 2, 'unidad-dialisis-3.jpeg', '2023-07-12'),
(10, 2, 'unidad-dialisis-4.jpeg', '2023-07-12'),
(11, 11, 'vision.png', '2021-02-02'),
(12, 11, '+.png', '2021-02-02'),
(13, 11, 'portapapeles.png', '2021-02-02'),
(14, 11, 'mision-cumplida.png', '2021-02-02');
...
INSERT INTO `historial_asistencia` (`id_historial`, `id_empleado`, `Hora`, `fecha`, `fecha_hora`, `tipo`, `Nota`) VALUES
(1, 33, '03:34:41', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(2, 33, '03:39:01', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(3, 34, '03:42:55', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(4, 77, '02:43:36', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(5, 78, '02:44:33', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(6, 33, '13:37:41', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(7, 17, '838:59:59', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(8, 34, '838:59:59', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(9, 17, '16:07:09', '2023-12-02', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(10, 12, '16:33:43', '2023-12-11', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(11, 14, '17:47:16', '2023-12-11', '2023-12-11 18:08:54', 'aaaaaaaa', 'bbbbbb'),
(12, 80, '18:19:22', '2023-12-11', '2023-12-11 18:19:22', 'aaaaaaaa', 'bbbbbb'),
(13, 80, '02:33:59', '2023-12-15', '2023-12-15 02:33:59', 'aaaaaaaa', 'bbbbbb'),
(14, 33, '02:44:19', '2023-12-15', '2023-12-15 02:44:19', 'aaaaaaaa', 'bbbbbb');
...
CREATE TABLE `noticias` (
  ...
  `descripcion_noticia` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `noticias` (`id_noticia`, `resumen`, `titulo_noticia`, `descripcion_noticia`, `categoria_noticia`, `imagen_principal`, `fecha_noticia`) VALUES
(1, 'Para potenciar el área comercial y productiva, el gobernador del estado Lara, Adolfo Pereira junto al C/A Juan Carlos Romero, presidente de la Empresa de Comercio Exterior de la entidad (Emcoex), anunciaron el lanzamiento del portafolio “Lara Exporta', 'Lara Exportable 2023', 'Portafolio lara exportable que reúne los productos que han sido exportados a 25 paises por encoex desde el puerto seco GD Jacinto Lara y ademas se encuentran los diferentes productos porducidos en el estado lara con calidad de exportacion', 'Economia', 'lara-exportable-1.webp', '2023-10-11'),
(2, 'Se inauguro la nueva unidad de dialisis en el hospital Pastor Oropeza', 'Unidad de Dialisis en carora', 'El gobernador de la entidad larense, Adolfo Pereira junto a Magaly Gutiérrez, Ministra del Poder Popular para la Salud, efectuaron la inauguración de la Unidad de Hemodiálisis G/D Pedro León Torres, ubicada en la parroquia Trinidad Samuel del municipio Torres, obra que contó con una inversión de más de 4 millones de bolívares digitales y ofrecerá una atención de calidad a los pacientes renales de la jurisdicción.\r\n\r\nLa infraestructura totalmente nueva contempla sala peritoneal, quirófano, consultas de psicología, nutrición, nefrología, igualmente área para pacientes positivos y sala general de diálisis. “Hoy estamos saldando una deuda en materia de salud junto a la ministra Magaly Gutiérrez, brindando una atención oportuna y de calidad a los 80 pacientes renales que tiene este municipio», así lo manifestó el gobernador desde el Hospital Dr. Pastor Oropeza Riera de Carora.\r\n\r\nDestacó el mandatario regional que también se hizo entrega de una ambulancia nueva enviada por el presidente Nicolás Maduro, «con esta unidad de diálisis en Torres no será necesario el traslado de pacientes para otro municipio, lo que indudablemente mejora su calidad de vida», acotó Pereira.\r\n\r\nA la par, la ministra expresó que todo el equipamiento con el que cuenta el espacio médico, es de avanzada tecnología y completamente nuevo, “aquí no hay equipos reparados, todos fueron adquiridos nuevos, porque eso es lo que merecen todos nuestros pacientes”, acotó.\r\n\r\nDestacó la autoridad nacional la existencia de 7.500 pacientes renales en el país, «seguimos trabajando para ofrecer un tratamiento gratuito, esto es a diario, una inversión que se hace en las 172 unidades que hay en Venezuela”, destacó la importancia de que la obra entregada sea un ejemplo de cómo deben permanecer las distintas infraestructuras de salud a nivel nacional.\r\n\r\nGutiérrez precisó que en Lara hay 47 obras en materia de salud en ejecución, de las cuales 10 están por inaugurar, «estamos buscando los equipamientos requeridos para ofrecer más salud a los larenses y de esta manera ir ayudando a cada paciente que lo amerite», dijo.\r\n\r\nUno de los pacientes renales llamado Amado Cañizales, destacó la importancia de la cercanía del centro, «ya no tendré que madrugar para otro municipio, gastaba todo el día en el proceso y era bastante agotador, sobre todo por mi condición, ya a partir de mañana mi tratamiento será más rápido y en el municipio donde habito», comentó con emoción.\r\n\r\nPara finalizar, el gobernador informó que se instalaron luminarias alrededor del Hospital Dr. Pastor Oropeza, lugar donde permanece la nueva Unidad de Hemodiálisis; adicionalmente, a través de la Gran Misión Venezuela Bella y la Gobernación del estado Lara, se está llevando a cabo el plan de asfaltado en el punto y círculo del recinto hospitalario.', 'Salud', 'unidad-dialisis-3.jpeg', '2023-11-01'),
(10, 'victor', 'victor', 'victor', 'victor', '1694114780500.jpg', '2023-11-14'),
(11, 'edirmary', 'edirmary  ', '            fgfdbd    ', 'edirmary  ', 'WhatsApp Image 2023-10-16 at 11.43.54 AM.jpeg', '2021-02-02');
...
INSERT INTO `prima_antiguedad` (`id`, `Años`, `Porcentaje`) VALUES
(1, 1, 1.00),
(2, 2, 2.00),
(3, 3, 3.00),
(4, 4, 4.00),
...
--
-- Estructura de tabla para la tabla `prima_profesionalizacion`
--

CREATE TABLE `prima_profesionalizacion` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `prima_profesionalizacion`
--

INSERT INTO `prima_profesionalizacion` (`id`, `Tipo`, `Porcentaje`) VALUES
(1, 'Técnico superior universitario', 20.00),
(2, 'Profesional', 25.00),
(3, 'Especialista', 30.00),
(4, 'Maestría', 35.00),
(5, 'Doctor', 40.00);
...
--
-- Estructura de tabla para la tabla `proyectopostulado`
--

CREATE TABLE `proyectopostulado` (
  `id` int(11) NOT NULL,
  `nombre` varchar(250) NOT NULL,
  `telefono` varchar(250) NOT NULL,
  `correo` varchar(50) NOT NULL,
  `titulo_proyecto` varchar(250) NOT NULL,
...
--
-- Volcado de datos para la tabla `proyectopostulado`
--

INSERT INTO `proyectopostulado` (`id`, `nombre`, `telefono`, `correo`, `titulo_proyecto`, `descripcion`, `estatus`, `fecha_hora`) VALUES
(1, 'victor', '04262553540', 'victorcamacaro253@gmail.com', 'Titulo del Proyectos', 'Descripción del proyecto', 'pendiente', '2023-12-11 03:13:18');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `salarios_trabajadores`
--

CREATE TABLE `salarios_trabajadores` (
  `Id_salario` int(11) NOT NULL,
  `id_empleado` int(11) NOT NULL,
  `Sueldo_base` int(11) NOT NULL,
  `Prima_por_hijo` int(11) NOT NULL,
  `Prima_de_profesionalizacion` int(11) NOT NULL,
  `Prima_de_antiguedad` int(11) NOT NULL,
  `Total_Asignacion_mensual` decimal(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `salarios_trabajadores`
--

INSERT INTO `salarios_trabajadores` (`Id_salario`, `id_empleado`, `Sueldo_base`, `Prima_por_hijo`, `Prima_de_profesionalizacion`, `Prima_de_antiguedad`, `Total_Asignacion_mensual`) VALUES
(1, 22, 9, 13, 2, 1, 500.00);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `siamtel_afiliacion`
--

CREATE TABLE `siamtel_afiliacion` (
  `Id_afiliacion` int(11) NOT NULL,
  `id_empleado` int(11) NOT NULL,
  `Conyuge` varchar(250) NOT NULL,
  `Cedula_conyuge` varchar(30) NOT NULL,
  `Madre` varchar(250) NOT NULL,
  `Cedula_madre` varchar(11) NOT NULL,
  `Padre` varchar(250) NOT NULL,
  `Cedula_padre` varchar(30) NOT NULL,
  `Hijos` varchar(250) NOT NULL,
  `imagen_carnet` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `siamtel_afiliacion`
--

INSERT INTO `siamtel_afiliacion` (`Id_afiliacion`, `id_empleado`, `Conyuge`, `Cedula_conyuge`, `Madre`, `Cedula_madre`, `Padre`, `Cedula_padre`, `Hijos`, `imagen_carnet`) VALUES
(1, 34, 'No tiene', '', '', '', '', '', 'Shaily Torres', 'carnet_sharon_torres.png'),
(2, 33, 'Roxana Suarez ', '22198539', 'Nivia Daza', '4385201', 'Wiliam Meléndez', '3539996', 'Joswil Meléndez, Jesús Meléndez\r\n\r\n', 'carnet_wilniv_melendez.png');
...
INSERT INTO `sueldo_base` (`Id`, `Tipo`, `Valor`) VALUES
(1, 'BI-I', 130),
(2, 'BI-II', 132),
(3, 'BI-III', 134),
(4, 'BI-IV', 135),
...
(12, 'PI-IV', 252),
(13, 'Coordinador', 348),
(14, 'Jefe_de_oficina', 363),
(15, 'Gerentes', 376),
(16, 'Gerente_general', 391),
(17, 'Presidente', 409);
...
--
-- Indices de la tabla `cdees_datos`
--
ALTER TABLE `cdees_datos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_pres_fk` (`Presidente`);
...
ALTER TABLE `ciudades`
  ...
  ADD KEY `ciudades_ibfk_1` (`id_estado`);

--
-- Indices de la tabla `datosescolares_hijostrabajadores`
--
ALTER TABLE `datosescolares_hijostrabajadores`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `fk_id_empleado_1` (`id_empleado`),
  ADD KEY `fk_id_estado_2` (`Estado`),
  ADD KEY `fk_id_municipio_2` (`Municipio`),
  ADD KEY `fk_id_parroquia` (`Parroquia`);
...
--
-- Indices de la tabla `detallepresuspuesto`
--
ALTER TABLE `detallepresuspuesto`
  ADD KEY `id_fk_presupuesto` (`id_presupuesto`);
...
ALTER TABLE `galeria`
  ...
  ADD KEY `id_noticia_fk` (`id_noticia`);
...
ALTER TABLE `historial_asistencia`
  ...
  ADD KEY `fk_id_usuario` (`id_empleado`);
...
ALTER TABLE `municipios`
  ...
  ADD KEY `municipios_ibfk_1` (`id_estado`);
...
ALTER TABLE `parroquias`
  ...
  ADD KEY `parroquias_ibfk_1` (`id_municipio`);
...
--
-- Indices de la tabla `prima_profesionalizacion`
--
ALTER TABLE `prima_profesionalizacion`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `proyectopostulado`
--
ALTER TABLE `proyectopostulado`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `salarios_trabajadores`
--
ALTER TABLE `salarios_trabajadores`
  ADD PRIMARY KEY (`Id_salario`),
  ADD KEY `fk_id_usuarios_salario` (`id_empleado`),
  ADD KEY `fk_sueldo_base` (`Sueldo_base`),
  ADD KEY `fk_prima_profesionalizacion` (`Prima_de_profesionalizacion`),
  ADD KEY `fk_antiguedad` (`Prima_de_antiguedad`);

--
-- Indices de la tabla `siamtel_afiliacion`
--
ALTER TABLE `siamtel_afiliacion`
...
--
-- AUTO_INCREMENT de la tabla `cdees_datos`
--
ALTER TABLE `cdees_datos`
...
--
-- AUTO_INCREMENT de la tabla `datosescolares_hijostrabajadores`
--
ALTER TABLE `datosescolares_hijostrabajadores`
...
--
ALTER TABLE `empleados`
  MODIFY `id_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
-- AUTO_INCREMENT de la tabla `prima_profesionalizacion`
--
ALTER TABLE `prima_profesionalizacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `proyectopostulado`
--
ALTER TABLE `proyectopostulado`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `salarios_trabajadores`
--
ALTER TABLE `salarios_trabajadores`
  MODIFY `Id_salario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `siamtel_afiliacion`
--
ALTER TABLE `siamtel_afiliacion`
  MODIFY `Id_afiliacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `bienes`
  ADD CONSTRAINT `fk_responsable` FOREIGN KEY (`Responsable`) REFERENCES `departamentos` (`id_departamento`);

--
-- Filtros para la tabla `cdees_datos`
--
ALTER TABLE `cdees_datos`
  ADD CONSTRAINT `id_pres_fk` FOREIGN KEY (`Presidente`) REFERENCES `empleados` (`id_empleado`);
...
--
-- Filtros para la tabla `datosescolares_hijostrabajadores`
--
ALTER TABLE `datosescolares_hijostrabajadores`
  ADD CONSTRAINT `fk_id_empleado_1` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id_empleado`),
  ADD CONSTRAINT `fk_id_estado_2` FOREIGN KEY (`Estado`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `fk_id_municipio_2` FOREIGN KEY (`Municipio`) REFERENCES `municipios` (`id_municipio`),
  ADD CONSTRAINT `fk_id_parroquia` FOREIGN KEY (`Parroquia`) REFERENCES `parroquias` (`id_parroquia`);

--
-- Filtros para la tabla `detallepresuspuesto`
--
ALTER TABLE `detallepresuspuesto`
  ADD CONSTRAINT `id_fk_presupuesto` FOREIGN KEY (`id_presupuesto`) REFERENCES `presupuesto` (`ID`);
...
--
ALTER TABLE `historial_asistencia`
  ADD CONSTRAINT `fk_id_usuario` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id_empleado`);
...
--
-- Filtros para la tabla `salarios_trabajadores`
--
ALTER TABLE `salarios_trabajadores`
  ADD CONSTRAINT `fk_antiguedad` FOREIGN KEY (`Prima_de_antiguedad`) REFERENCES `prima_antiguedad` (`id`),
  ADD CONSTRAINT `fk_id_usuarios_salario` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id_empleado`),
  ADD CONSTRAINT `fk_prima_profesionalizacion` FOREIGN KEY (`Prima_de_profesionalizacion`) REFERENCES `prima_profesionalizacion` (`id`),
  ADD CONSTRAINT `fk_sueldo_base` FOREIGN KEY (`Sueldo_base`) REFERENCES `sueldo_base` (`Id`);

--
-- Filtros para la tabla `siamtel_afiliacion`
--
ALTER TABLE `siamtel_afiliacion`
